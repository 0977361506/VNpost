		...
		<div class="container">
			<div class="panel panel-default hello" style="height: 400px; width: 380px; margin: 40px 400px ; margin-bottom: 100px;">
				<div class="panel-body" >
					<div>
						<form action="/forget/pass" method="post" accept-charset="utf-8">
						<p>${mes1}</p>
							...
							<div class="form-group">
								<label>Email</label>
								<input  name="mail"  class="form-control" style="margin-left: 80px; width: 60%;"  value="${pww}" >
							</div>
							...
							<div>
							   <a href="/home/index" title="">Trang Chủ</a>
							</div>
						</form>
					</div>
				</div>
