...
<body>
	...
	<div class="row">
		<div class="container-fluid">
			<div class="col col-sm-4 danhmuc" style="background-color: #FFFAD5; height: 500px; display: inline-block; width: 300px; margin-left:90px; padding: 0px; margin-top:20px; margin-bottm: 20px;">
			...
			<div class="col col-sm-8 tintucnoibat" style=" height: 70% !importaint; display: inline-block; float: right;height: 100%; margin-right: 50px; margin-bottom: 20px; margin-top:-20px;">
				<div class="tieude" style="display: block; padding: 0;">
					<ul class="nav">
						<li class="nav-item">
							<a class="nav-link active" href="#">Tin Vietnam Post</a>
						</li>
						 <c:forEach var="v" items="${listdm}">
								<li>
									<a  href="#">${v.tenDM}</a>
