...
<body>
			...
			<div class="row">
				...
				<div class="col col-sm-9 col-right" style="padding-right: 200px;">
					<ul class="list-unstyled list-inline" style="float: right">
						<li><a href="/home/index" title=""></a>Giới Thiệu</li>
						...
						<nav class="nav">
							...
							<div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse vip5">
								<ul class="nav nav-pills nav-justified ul-main-menu" style="margin-top: 8px;">
									...
									<li><a href="/phanphoi/vn" id="dnn_ctl11_rptService_hplMenu_0"><span>Bưu chính chuyển</span>&nbsp;<span>phát</span></a></li>

									<li><a href="/taichinh/vn" id="dnn_ctl11_rptService_hplMenu_1"><span>Tài Chính Bưu</span>&nbsp;<span>Chính</span></a></li>

									<li><a href="/phanphoi/vn" id="dnn_ctl11_rptService_hplMenu_2"><span>Phân Phối - Truyền</span>&nbsp;<span>Thông</span></a></li>
	...
	<div class="container" style="height: 1000px;">
			...
			<div class="headers">
				<h1 class="text-center">TÀI CHÍNH BƯU CHÍNH</h1>
			</div>
			<div class="row" style="margin-top:50px;">
				<div class="col col-sm-4" >
					<div class="anh">
						<a href="" title="">
							<img src="/img/hl7.jpg" alt="anhmang" style=" max-width: 100%; max-height:400px; width:100%; ">
                             <h1 class="tietkiem">Tiết Kiệm Bưu Điện</h1>
						</a>
						<div id="vv">
							
							<p id="tiet" >Dịch vụ tiết kiệm Bưu điện được cung cấp trên mạng lưới Bưu chính đã đáp ứng được nhu cầu gửi tiền tiết kiệm của hàng triệu khách hàng trên khắp mọi...</p>
						</div>
					</div>
				</div>
				<div class="col col-sm-4">
					<div class="anh">
						<a href="" title="">
							<img src="/img/hl8.jpg" alt="anhmang" style=" max-width: 100%; max-height:400px; width:100%; ">
                            <h1 class="tietkiem">Tiết Kiệm Bưu Điện</h1>
						</a>
						<p id="tiet">Dịch vụ tiết kiệm Bưu điện được cung cấp trên mạng lưới Bưu chính đã đáp ứng được nhu cầu gửi tiền tiết kiệm của hàng triệu khách hàng trên khắp mọi...</p>
					</div>
				...
				<div class="col col-sm-4">
					<div class="anh">
						<a href="" title="">
							<img src="/img/hl9.jpg" alt="anhmang" style=" max-width: 100%; max-height:400px; width:100%; ">
                            <h1 class="tietkiem">Tiết Kiệm Bưu Điện</h1>
						</a>
						<p id="tiet">Dịch vụ tiết kiệm Bưu điện được cung cấp trên mạng lưới Bưu chính đã đáp ứng được nhu cầu gửi tiền tiết kiệm của hàng triệu khách hàng trên khắp mọi...</p>
					</div>
			...
			<div class="row" style="margin-top:50px;">
				<div class="col col-sm-4">
					<div class="anh">
						<a href="" title="">
							<img src="/img/hl10.jpg" alt="anhmang" style=" max-width: 100%; max-height:400px; width:100%; ">
                            <h1 class="tietkiem">Tiết Kiệm Bưu Điện</h1>
						</a>
						<p id="tiet">Dịch vụ tiết kiệm Bưu điện được cung cấp trên mạng lưới Bưu chính đã đáp ứng được nhu cầu gửi tiền tiết kiệm của hàng triệu khách hàng trên khắp mọi...</p>
					</div>
				...
				<div class="col col-sm-4">
					<div class="anh">
						<a href="" title="">
							<img src="/img/hl11.jpg" alt="anhmang" style=" max-width: 100%; max-height:400px; width:100%; ">
                            <h1 class="tietkiem">Tiết Kiệm Bưu Điện</h1>
						</a>
						<p id="tiet">Dịch vụ tiết kiệm Bưu điện được cung cấp trên mạng lưới Bưu chính đã đáp ứng được nhu cầu gửi tiền tiết kiệm của hàng triệu khách hàng trên khắp mọi...</p>
					</div>
				...
				<div class="col col-sm-4">
					<div class="anh">
						<a href="" title="">
							<img src="/img/hl12.jpg" alt="anhmang" style=" max-width: 100%; max-height:400px; width:100%; ">
                            <h1 class="tietkiem">Tiết Kiệm Bưu Điện</h1>
						</a>
						<p id="tiet">Dịch vụ tiết kiệm Bưu điện được cung cấp trên mạng lưới Bưu chính đã đáp ứng được nhu cầu gửi tiền tiết kiệm của hàng triệu khách hàng trên khắp mọi...</p>
					</div>
