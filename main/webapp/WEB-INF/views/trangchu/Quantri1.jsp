<%@ page  pageEncoding="utf-8"%>
	...
	<form action="" method="get" >
		...
		<label>Tên bảng danh mục : </label>
		<input type="select" name="" placeholder="Tất cả" style="width:30%;">
		<div style="border-bottom:1px solid gray; width: 86%; margin-top: 40px;" ></div>


		<div class="container" style="margin-left:68%; margin-top: 20px;">
			
			<button type="button" class="btn btn-primary ">Tìm kiếm</button>
			<button type="button" class="btn btn-primary btn-md">Thêm mới</button>    
